...
class ShopsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $param = [
            ...
            'image_path' => 'images/shops/sushi.png'
        ];
        ...
        $param = [
            ...
            'image_path' => 'images/shops/yakiniku.png'
        ];
        DB::table('shops')->insert($param);
        ...
        $param = [
            ...
            'image_path' => 'images/shops/izakaya.png'
        ];
        DB::table('shops')->insert($param);
        ...
        $param = [
            ...
            'image_path' => 'images/shops/italian.png'
        ];
        DB::table('shops')->insert($param);
        ...
        $param = [
            ...
            'image_path' => 'images/shops/ramen.png'
        ];
        DB::table('shops')->insert($param);
